...
import changInfoApi from '../../api/changeInfo';
...
export default class ChangeInfo extends Component {
    ...
    change(){
        ...
        getToken()
        .then(token => changInfoApi(token, txtName, txtPhone, txtAddress))
        .then(user => {this.alertSuccess()
...
const styles = StyleSheet.create({
    ...
    header: { flex: 1, backgroundColor: '#3473d8', alignItems: 'center', flexDirection: 'row', justifyContent: 'space-between' },
